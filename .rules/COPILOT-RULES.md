# AI Assistant & GitHub Copilot Rules

**Created:** 2026-02-24  
**Purpose:** Unified rules for all AI assistants (Claude, GitHub Copilot, etc.) working on this project

These are the rules that ANY AI assistant should follow when working with this MCP project management system. Use these to guide the AI tool to maintain consistency, quality, and auditability.
...
- [ ] **Review acceptance criteria** — These define "done". Must verify every one before marking `DONE`.
...
6. List acceptance criteria — these are the "definition of done"
...
1. If a non-obvious choice was made, create or update a related ADR
...
4. Verify reproduction steps (can it be recreated?)
...
**CRITICAL:** AI assistants do NOT create git commits.
...
3. **Create an ADR** — If about to make a costly decision, draft an ADR and ask for approval before implementing
4. **Run systems thinking** — If confused about scope, run through the checklist and document findings
...
- ✅ 6 months from now, team can audit "who fixed this bug and when?" by reading the bug file + git links
- ✅ Any AI assistant (Claude, GitHub Copilot, etc.) can pick up work and follow the same patterns consistently
