...
{
    [McpServerTool(Name = McpToolName.Clients.Search), Description("Search clients by name, industry, or type (Individual or Organization).")]
    ...
    [McpServerTool(Name = McpToolName.Clients.Get), Description("Retrieve a client's full profile and engagement history, including all associated cases.")]
    ...
    [McpServerTool(Name = McpToolName.Clients.ConflictCheck), Description("Run a conflict-of-interest check for a potential new client or matter against existing firm relationships.")]
    ...
    [McpServerTool(Name = McpToolName.Contacts.Search), Description("Search contacts such as witnesses, expert witnesses, judges, and opposing counsel.")]
    ...
    [McpServerTool(Name = McpToolName.Contacts.Get), Description("Retrieve full contact details by contact ID.")]
