...
{
    [McpServerTool, Description("Search case law precedents by topic, jurisdiction, date range, and practice area.")]
    ...
    [McpServerTool, Description("Retrieve the text and annotations for a specific statute by ID and jurisdiction.")]
    ...
    [McpServerTool, Description("Retrieve a research memo by ID, including full findings and tags.")]
    ...
    [McpServerTool, Description("Create a new research memo linked to a case.")]
