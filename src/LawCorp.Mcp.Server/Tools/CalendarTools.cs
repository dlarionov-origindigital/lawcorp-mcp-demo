...
{
    [McpServerTool(Name = McpToolName.Calendar.GetHearings), Description("Get upcoming court hearings for a case or attorney within a date range.")]
    ...
    [McpServerTool(Name = McpToolName.Calendar.GetDeadlines), Description("Get filing deadlines and statute of limitations dates, optionally filtered by urgency.")]
    ...
    [McpServerTool(Name = McpToolName.Calendar.AddEvent), Description("Add a hearing, filing deadline, or meeting to the case calendar.")]
    ...
    [McpServerTool(Name = McpToolName.Calendar.GetConflicts), Description("Check for scheduling conflicts for one or more attorneys at a proposed date/time.")]
