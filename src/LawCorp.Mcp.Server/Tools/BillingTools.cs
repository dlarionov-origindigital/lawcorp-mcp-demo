...
{
    [McpServerTool(Name = McpToolName.Billing.TimeEntriesLog), Description("Log billable or non-billable time for a user on a case.")]
    ...
    [McpServerTool(Name = McpToolName.Billing.TimeEntriesSearch), Description("Search time entries by user, case, date range, and billable status.")]
    ...
    [McpServerTool(Name = McpToolName.Billing.GetSummary), Description("Get a billing summary (total hours, billed, outstanding) for a case or client.")]
    ...
    [McpServerTool(Name = McpToolName.Billing.InvoicesSearch), Description("Search invoices by client, status, and date range.")]
    ...
    [McpServerTool(Name = McpToolName.Billing.InvoicesGet), Description("Retrieve full invoice details including all line items.")]
